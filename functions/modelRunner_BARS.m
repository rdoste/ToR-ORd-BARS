...
function [ time, X, parameters ] = modelRunner_BARS( X0, options, parameters, beats, ignoreFirst)
...
for n=1:beats
    ...
    %BARS phosphorilation values
    extraParams.ISO=parameters.ISO(n);
    extraParams.BCL=parameters.bcl;
    extraParams.runSignalingPathway=parameters.runSignalingPathway(n);
